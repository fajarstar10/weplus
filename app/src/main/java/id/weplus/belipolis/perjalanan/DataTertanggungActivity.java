...
public class DataTertanggungActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_tertanggung);
        ButterKnife.bind(this);
        title.setText(getString(R.string.isidatatertanggung));
    ...
    public void simpanFormPemegangPolis(){
        ...
        String v_provinsi = provinsi.getSelectedItem().toString();
        String v_kota = kota.getSelectedItem().toString();
        ...
        fppmd.setAddress(v_address);
        fppmd.setProvinsi(v_provinsi);
        fppmd.setKota(v_kota);
