...
public class GadgetProductListAdapter extends RecyclerView.Adapter<GadgetProductListAdapter.ProductViewHolder>
        implements Filterable {
    private Activity activity;
    private int catId;
    private GadgetProductRequest request;
    private List<Product> products;
    private List<Product> originalProduct;
    private GadgetProductListAdapter.ItemFilter mItemFilter = new GadgetProductListAdapter.ItemFilter();


    public GadgetProductListAdapter(Activity activity, List<Product> productList, int catId, GadgetProductRequest requestBody) {
    ...
    @Override
    public GadgetProductListAdapter.ProductViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View childView = LayoutInflater.from(activity).inflate(R.layout.viewadapter_produk_terbaru, viewGroup, false);
        return new GadgetProductListAdapter.ProductViewHolder(childView);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(GadgetProductListAdapter.ProductViewHolder holder, int i) {
