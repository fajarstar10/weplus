...
public class MotorProductListAdapter extends RecyclerView.Adapter<MotorProductListAdapter.ProductViewHolder>
    ...
    private MotorProductListAdapter.ItemFilter mItemFilter = new MotorProductListAdapter.ItemFilter();


    public MotorProductListAdapter(Activity activity, List<Product> productList, int catId,MotorProductListRequest motorRequest) {
    ...
    @Override
    public MotorProductListAdapter.ProductViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(MotorProductListAdapter.ProductViewHolder holder, int i) {
