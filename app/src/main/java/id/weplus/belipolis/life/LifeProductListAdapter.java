...
public class LifeProductListAdapter extends RecyclerView.Adapter<LifeProductListAdapter.ProductViewHolder>
    ...
    private LifeProductListRequest request;
    private LifeProductListAdapter.ItemFilter mItemFilter = new LifeProductListAdapter.ItemFilter();


    public LifeProductListAdapter(Activity activity, List<Product> productList, int catId, LifeProductListRequest motorRequest) {
    ...
    @Override
    public LifeProductListAdapter.ProductViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View childView = LayoutInflater.from(activity).inflate(R.layout.viewadapter_produk_terbaru, viewGroup, false);
        return new LifeProductListAdapter.ProductViewHolder(childView);
    }

    @SuppressLint("SetTextI18n")
    @Override
    public void onBindViewHolder(LifeProductListAdapter.ProductViewHolder holder, int i) {
