...
public class AsuransiLifeActivity extends BaseActivity implements OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_asuransi_life);
    ...
    private void setupDatePicker() {
        ...
        int minAge = calendar.get(Calendar.YEAR);
    ...
    private void setupButtonNext() {
        btnNext.setOnClickListener(view -> {
            if(validate()){
                ...
                Intent intent = new Intent(AsuransiLifeActivity.this, LifeProductListActivity.class);
                intent.putExtra("requestBody", new LifeProductListRequest(
                       0,"",4,partnerId,dob,gender
                ));
