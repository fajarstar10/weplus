package id.weplus.belipolis.covid
...
class CovidDisclaimer : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_covid_disclaimer)
        setToolbar()
        getIntentData()
        setupButtonAction()
    }
    ...
    private fun getIntentData(){
        product = intent.getParcelableExtra<Product>("product_detail")!!
