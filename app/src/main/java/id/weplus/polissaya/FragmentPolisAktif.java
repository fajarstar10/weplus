...
public class FragmentPolisAktif extends Fragment {
    private static String TAG = "FragmentPolisAktif";
    @BindView(R.id.polissemua_rec)
    RecyclerView recSemua;
    @BindView(R.id.layout_no_polis) LinearLayout layoutPolisEmpty;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        layoutPolisEmpty.setVisibility(View.GONE);
        emptyLayout.setVisibility(View.GONE);
        getPolisAktif();
        btnBeliPolisSkrg.setOnClickListener(view1 -> {
            startActivity(new Intent(getActivity(), BeliPolisActivity.class));
        });
    }
    ...
    private void getPolisAktif() {
        if (getActivity() != null) {
            ...
            if (isNetworkAvailable) {
                ...
                Call<String> call = NetworkManager.getNetworkServiceWithHeader(getActivity(), token).getInsuredList(0);
                        ...
                        try {
                            ...
                            if (code.equals(ErrorCode.ERROR_00)) {
                                ...
                                if(insuredList.size()>0) {
                                    ...
                                    PolisSayaAdapter.PolisSayaOnItemClicked listener = (pos, tag) -> {
                                    ...
                                    layoutPolisEmpty.setVisibility(View.VISIBLE);
                                }
