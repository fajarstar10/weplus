...
public class RegistrationFormActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView buttonTest = findViewById(R.id.buttonTest);
        buttonTest.setOnClickListener(view -> finish());
        ...
        //mWebView.loadUrl(getIntent().getStringExtra("url"));//https://demo.weplus.id/mitra/apps/9541");
